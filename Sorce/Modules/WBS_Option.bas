...
Function オプション設定値格納()
  ...
  For line = 3 To endLine
    Call ProgressBar.showCount("オプション設定値格納", line, sheetSetting.Range("B5"), "ショートカットキー設定")
  ...
  For line = 4 To 38
    Call ProgressBar.showCount("オプション設定値格納", line, 38, "担当者:" & getVal("Assign" & Format(line - 3, "00")))
