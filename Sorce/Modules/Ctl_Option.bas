...
Function オプション設定値格納()
  ...
  For line = 3 To sheetSetting.Range("B5")
    'Call Ctl_ProgressBar.showCount("オプション設定値格納", line, sheetSetting.Range("B5"), sheetSetting.Range("A" & line) & ":" & getVal(sheetSetting.Range("A" & line)))
  ...
  For line = 3 To endLine
    Call ctl_ProgressBar.showCount("オプション設定値格納", line, sheetSetting.Range("B5"), "ショートカットキー設定")
