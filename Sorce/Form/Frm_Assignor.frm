VERSION 5.00
Begin {C62A69F0-16DC-11CE-9E98-00AA00574A4F} Frm_Assignor 
   Caption         =   "担当者選択"
   ClientHeight    =   5205
   ClientLeft      =   120
   ClientTop       =   465
   ClientWidth     =   8820
   OleObjectBlob   =   "Frm_Assignor.frx":0000
   StartUpPosition =   1  'オーナー フォームの中央
End
Attribute VB_Name = "Frm_Assignor"
...
'  Debug.Print (taskAllocation01.Text + taskAllocation02.Text + taskAllocation03.Text + taskAllocation04.Text + taskAllocation05.Text)
'  If (taskAllocation01.Text + taskAllocation02.Text + taskAllocation03.Text + taskAllocation04.Text + taskAllocation05.Text) <> 100 Then
'    ErrorMeg.Caption = "配分率の合計が、100%ではありません"
'    Exit Sub
'  End If
